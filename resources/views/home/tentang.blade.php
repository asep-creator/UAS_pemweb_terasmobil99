...
<section class="text-center mb-10 scroll-scale-up">
    ...
    <p class="text-gray-500 mt-4 mx-auto text-lg" style="max-width: 760px;">
...
<section class="grid md:grid-cols-3 gap-4 mb-10 scroll-scale-up">
    ...
    <div class="bg-white rounded-[2rem] shadow-lg p-6 text-center">
        <h2 class="text-red-500 font-bold text-5xl">500+</h2>
        <p class="text-gray-500 mt-2 mb-0">Pelanggan Puas</p>
    </div>

    <div class="bg-white rounded-[2rem] shadow-lg p-6 text-center">
        <h2 class="text-red-500 font-bold text-5xl">50+</h2>
        <p class="text-gray-500 mt-2 mb-0">Mobil Tersedia</p>
    </div>

    <div class="bg-white rounded-[2rem] shadow-lg p-6 text-center">
        <h2 class="text-red-500 font-bold text-5xl">10+</h2>
        <p class="text-gray-500 mt-2 mb-0">Tahun Pengalaman</p>
    </div>
...
<section class="bg-red-50 rounded-[2rem] p-8 text-center shadow-sm scroll-scale-up">
    ...
    <div class="flex flex-wrap justify-center gap-3">
        ...
        <a href="{{ route('galeri') }}"
           class="bg-gray-900 hover:bg-gray-800 text-white px-4 py-2 rounded-lg transition">
            Lihat Galeri
        </a>
